...
import com.sina.adm.base.components.encoder.Base64Encoder;
import com.sina.adm.base.components.encoder.DesEncoder;
 ...
 * 
 */
public class CustomerTokenTools {
	...
	public static String encryptToken(Long customerid) {
		String timestamp = DateUtils.format(new Date(), "ddHHmmssSSS");
	 ...
	 * @version 4.0
	 */
	public static String genToken(Long ucid, Long loginTime) {
		String token = "[SAX][" + ucid.toString() + "][" + String.valueOf(loginTime) + "]";
		return token;
	}
