...
/**
 * 为KA信息流访问gina数据库创建独立的sessionfactory
 * @author songjuan
 *
 */
public class KADynamicSessionFactoryImpl implements SessionFactory {
	 private static final long serialVersionUID = 5384069312247414885L;
	    ...
	    /**
	     * @see com.sina.ea.core.dao.sessionfactory.KADynamicSessionFactoryImpl#getHibernateSessionFactory()
	     * @author songjuan
	     * @createDate 2014-12-16 上午10:45:25
	     */
	    public SessionFactory getHibernateSessionFactory() {
	        SessionFactory targetSessionFactory = targetSessionFactorys.get(sessionFactoryKey.getKey());  
